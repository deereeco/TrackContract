...
interface ContractionEditFormProps {
  contraction: Contraction;
  onClose: () => void;
}

const ContractionEditForm = ({ contraction, onClose }: ContractionEditFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateContraction(contraction.id, {
        startTime,
        endTime,
        duration,
      ...
      alert('Failed to update contraction');
    }
  };
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Edit Contraction</h2>
          <button
            onClick={onClose}
...
export default ContractionEditForm;
